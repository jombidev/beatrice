...
from src.screen.impl.setting import SettingScreen
...
class MainScreen(Screen):
    def __start_music_selection(self):
        self.game.set_screen(MusicSelectScreen(self))
    ...
    def init_screen(self):
        target_y = 720 - 80 * 5
        self.__buttons.append(Button("start", 1280 / 2, target_y, True, self.__start_music_selection))
        self.__buttons.append(Button("settings", 1280 / 2, target_y + 50, True, self.__setting))
        self.__buttons.append(Button("exit", 1280 / 2, target_y + 100, True, self.__exit_game))
