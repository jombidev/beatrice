...
class MainScreen(Screen):
    ...
    def init_screen(self):
        self.overlays.clear()
        target_y = 720 - 80 * 5
        self.overlays.append(Button("start", 1280 / 2, target_y, None, None, True, self.__start_music_selection))
        self.overlays.append(Button("settings", 1280 / 2, target_y + 50, None, None, True, self.__setting))
        self.overlays.append(Button("exit", 1280 / 2, target_y + 100, None, None, True, self.__exit_game))
